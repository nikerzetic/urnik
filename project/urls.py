...
urlpatterns = [
    ...
    re_path(r'^oseba/(?P<oseba_id>\d+)/$', urnik.views.urnik_osebe, name='urnik_osebe'),
    re_path(r'^oseba/(?P<oseba_id>\d+)/(?P<teden>[0-9-]*)/$', urnik.views.urnik_osebe, name='urnik_osebe'),
